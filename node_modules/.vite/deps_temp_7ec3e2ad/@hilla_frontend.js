  ...
  constructor(initialState) {
    ...
    if (navigator.serviceWorker) {
      ...
      void navigator.serviceWorker.ready.then((registration) => {
        var _a4;
        (_a4 = registration.active) === null || _a4 === void 0 ? void 0 : _a4.postMessage({
...
var ConnectionIndicator = class _ConnectionIndicator extends LitElement {
  ...
  static create() {
    var _a4, _b;
    const $wnd4 = window;
    if (!((_a4 = $wnd4.Vaadin) === null || _a4 === void 0 ? void 0 : _a4.connectionIndicator)) {
      $wnd4.Vaadin || ($wnd4.Vaadin = {});
      $wnd4.Vaadin.connectionIndicator = document.createElement("vaadin-connection-indicator");
      document.body.appendChild($wnd4.Vaadin.connectionIndicator);
    }
    return (_b = $wnd4.Vaadin) === null || _b === void 0 ? void 0 : _b.connectionIndicator;
  }
  constructor() {
    super();
    this.firstDelay = 450;
  ...
  connectedCallback() {
    ...
    const $wnd4 = window;
    if ((_a4 = $wnd4.Vaadin) === null || _a4 === void 0 ? void 0 : _a4.connectionState) {
      this.connectionStateStore = $wnd4.Vaadin.connectionState;
  ...
  updateConnectionState() {
    var _a4;
    const state = (_a4 = this.connectionStateStore) === null || _a4 === void 0 ? void 0 : _a4.state;
...
(_a2 = $wnd2.Vaadin).registrations || (_a2.registrations = []);
...
var _endpointInfos, _nextId, _onCompleteCallbacks, _onErrorCallbacks, _onNextCallbacks, _pendingMessages, _socket, _connectWebsocket, connectWebsocket_fn, _handleMessage, handleMessage_fn, _removeSubscription, removeSubscription_fn, _send, send_fn, _sendPendingMessages, sendPendingMessages_fn;
var FluxConnection = class extends EventTarget {
  constructor(connectPrefix) {
    super();
    __privateAdd(this, _connectWebsocket);
    __privateAdd(this, _handleMessage);
    __privateAdd(this, _removeSubscription);
    __privateAdd(this, _send);
    __privateAdd(this, _sendPendingMessages);
    ...
    __privateMethod(this, _connectWebsocket, connectWebsocket_fn).call(this, connectPrefix.replace(/connect$/u, ""));
  }
  /**
  ...
  subscribe(endpointName, methodName, parameters) {
    ...
    __privateMethod(this, _send, send_fn).call(this, msg);
    __privateGet(this, _endpointInfos).set(id, endpointInfo);
    const hillaSubscription = {
      cancel: () => {
        ...
        __privateMethod(this, _send, send_fn).call(this, closeMessage);
        __privateMethod(this, _removeSubscription, removeSubscription_fn).call(this, id);
      },
      context(context) {
...
_socket = new WeakMap();
_connectWebsocket = new WeakSet();
connectWebsocket_fn = function(prefix) {
  var _a4, _b;
  ...
  __privateSet(this, _socket, (_b = (_a4 = import_atmosphere.default).subscribe) == null ? void 0 : _b.call(_a4, {
    ...
    onMessage: (response) => {
      if (response.responseBody) {
        __privateMethod(this, _handleMessage, handleMessage_fn).call(this, JSON.parse(response.responseBody));
      }
    },
    onOpen: (_response) => {
      if (this.state === "inactive") {
        ...
        __privateMethod(this, _sendPendingMessages, sendPendingMessages_fn).call(this);
      }
    },
    onReopen: (_response) => {
      if (this.state === "inactive") {
...
handleMessage_fn = function(message) {
  ...
  if (isClientMessage(message)) {
    const { id } = message;
    const endpointInfo = __privateGet(this, _endpointInfos).get(id) ?? "unknown";
    if (message["@type"] === "update") {
      ...
      (_a4 = __privateGet(this, _onCompleteCallbacks).get(id)) == null ? void 0 : _a4();
      __privateMethod(this, _removeSubscription, removeSubscription_fn).call(this, id);
    } else {
...
send_fn = function(message) {
  ...
  if (this.state === "inactive") {
    ...
    (_b = (_a4 = __privateGet(this, _socket)) == null ? void 0 : _a4.push) == null ? void 0 : _b.call(_a4, JSON.stringify(message));
  }
};
_sendPendingMessages = new WeakSet();
sendPendingMessages_fn = function() {
  __privateGet(this, _pendingMessages).forEach((msg) => __privateMethod(this, _send, send_fn).call(this, msg));
...
var _a3;
(_a3 = $wnd3.Vaadin).registrations ?? (_a3.registrations = []);
...
function isFlowLoaded() {
  var _a4, _b, _c;
  return ((_c = (_b = (_a4 = $wnd3.Vaadin) == null ? void 0 : _a4.Flow) == null ? void 0 : _b.clients) == null ? void 0 : _c.TypeScript) !== void 0;
}
var _fluxConnection;
var ConnectClient = class {
  ...
  constructor(options = {}) {
    ...
    __privateAdd(this, _fluxConnection, void 0);
    if (options.prefix) {
    ...
    addEventListener("online", () => {
      var _a4;
      if (!isFlowLoaded() && ((_a4 = $wnd3.Vaadin) == null ? void 0 : _a4.connectionState)) {
  ...
  get fluxConnection() {
    if (!__privateGet(this, _fluxConnection)) {
      __privateSet(this, _fluxConnection, new FluxConnection(this.prefix));
    }
  ...
  async call(endpoint, method, params, init2) {
    ...
    async function fetchNext(context) {
      ...
      (_b = (_a4 = $wnd3.Vaadin) == null ? void 0 : _a4.connectionState) == null ? void 0 : _b.loadingStarted();
      try {
        const response = await fetch(context.request, { signal: init2 == null ? void 0 : init2.signal });
        (_d = (_c = $wnd3.Vaadin) == null ? void 0 : _c.connectionState) == null ? void 0 : _d.loadingFinished();
        return response;
      } catch (error) {
        if (error instanceof Error && error.name === "AbortError") {
          (_f = (_e = $wnd3.Vaadin) == null ? void 0 : _e.connectionState) == null ? void 0 : _f.loadingFinished();
        } else {
          (_h = (_g = $wnd3.Vaadin) == null ? void 0 : _g.connectionState) == null ? void 0 : _h.loadingFailed();
        }
...
function __REGISTER__(feature) {
  ...
  (_a4 = window.Vaadin).registrations ?? (_a4.registrations = []);
